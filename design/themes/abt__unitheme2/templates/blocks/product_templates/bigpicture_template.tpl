...
{if $settings.ab__device !== "mobile"}
    ...
    <div class="ut2-pb ty-product-block ty-product-detail ut2-big-image {if $product_images_count < 1}--single{/if}" style="--pd-image-gallery-width: {$pd_image_gallery_width};--pd-image-gallery-height: {$pd_image_gallery_height}">
            ...
            <div class="ut2-pb__wrapper clearfix">
                ...
                <div class="ut2-pb__img-wrapper">
                    {hook name="products:image_wrap"}
                        {if !$no_images}
                            <div class="ut2-pb__img cm-reload-{$product.product_id} images-{$settings.abt__ut2.products[$settings.abt__details_layout].multiple_product_images[$settings.ab__device]}">{include file="views/products/components/product_images.tpl" image_width=$pd_image_gallery_width image_height=$pd_image_gallery_height product=$product show_detailed_link="YesNo::YES"|enum}
