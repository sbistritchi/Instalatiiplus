...
{if $settings.ab__device !== "mobile"}
    ...
    <div class="ut2-pb ty-product-block ty-product-detail ut2-big-image ut2-big-image-flat {if $product_images_count < 1}--single{/if}" style="--pd-image-gallery-width: {$pd_image_gallery_width};--pd-image-gallery-height: {$pd_image_gallery_height}">
