...
{if $settings.ab__device !== "mobile"}
    ...
    <div class="ut2-pb ty-product-block ty-product-detail ut2-big-image ut2-big-image-gallery {if $product_images_count > 1}--three{elseif $product_images_count == 1}--double{else}--single{/if}" style="--pd-image-gallery-width: {$pd_image_gallery_width};--pd-image-gallery-height: {$pd_image_gallery_height}">
        ...
        {if $product}
            ...
            <div class="ut2-pb__img-wrapper">
                {hook name="products:image_wrap"}
                    {if !$no_images}
                        <div class="ut2-pb__img images-{$settings.abt__ut2.products[$settings.abt__details_layout].multiple_product_images[$settings.ab__device]} cm-reload-{$product.product_id} {if $settings.Appearance.thumbnails_gallery == "YesNo::YES"|enum}ut2-pb__as-gallery{else}ut2-pb__as-thumbs{/if}"
                             data-ca-previewer="true" id="product_images_{$product.product_id}_update">
                            {include file="views/products/components/product_images.tpl" image_width=$pd_image_gallery_width image_height=$pd_image_gallery_height product=$product show_detailed_link="YesNo::YES"|enum}
