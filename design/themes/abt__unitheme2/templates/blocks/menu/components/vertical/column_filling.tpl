...
{if !$item1.$childs|fn_check_second_level_child_array:$childs}
    {hook name="blocks:topmenu_dropdown_2levels_elements"}
        ...
        <div class="ty-menu__submenu-items cm-responsive-menu-submenu ut2-simple {if $item1.abt__ut2_mwi__text && $item1.abt__ut2_mwi__dropdown === "YesNo::NO"|enum}{if $item1.abt__ut2_mwi__text_position !== "bottom"}with-pic {else}with-bottom-pic{/if}{/if}">
