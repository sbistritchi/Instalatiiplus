...
<div class="ty-gift-certificate-wishlist ty-column{$columns}">
    <div class="ut2-gl__item">
        ...
        <form>
        <div class="ut2-gl__body" style="min-height: {$smarty.capture.abt__ut2_gl_item_height nofilter}px">

            <div class="ut2-gl__image" style="height:{$tbh}px">
            ...
            {if $settings.abt__ut2.product_list.price_position_top|default:{"YesNo::YES"|enum} == "YesNo::YES"|enum}
                ...
                <div class="ut2-gl__price ty-price-num" style="min-height: {$smarty.capture.abt__ut2_pr_block_height nofilter}px;">
            ...
            <div class="ut2-gl__content" style="height: {$smarty.capture.abt__ut2_gl_content_height nofilter}px">
                ...
                {if $settings.abt__ut2.product_list.price_position_top|default:{"YesNo::YES"|enum} == "YesNo::NO"|enum}
                    <div class="ut2-gl__price pr-{$settings.abt__ut2.product_list.price_display_format}{if $product.list_discount || $product.discount} pr-color{/if}" style="min-height: {$smarty.capture.abt__ut2_pr_block_height nofilter}px;">
                        <div><span class="ty-price-update"><span class="ty-price ty-price-num">{include file="common/price.tpl" value=$gift.amount}</span></span></div>
                    </div>
