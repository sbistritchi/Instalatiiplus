...
<div class="controls">
<input type="hidden" name="static_data[abt__ut2_mwi__dropdown]" value="N">
<input type="checkbox" id="abt__ut2_mwi__dropdown_{$id}" name="static_data[abt__ut2_mwi__dropdown]" value="Y"{if $static_data.abt__ut2_mwi__dropdown == "YesNo::YES"|enum} checked="checked"{/if}>
</div>
</div>
{else}
<input type="hidden" name="static_data[abt__ut2_mwi__dropdown]" value="{$static_data.abt__ut2_mwi__dropdown|default:"N"}">
<input type="hidden" name="static_data[abt__ut2_mwi__desc]" value="{$static_data.abt__ut2_mwi__desc}">
{/if}
{** text **}
<div class="control-group">
...
<div class="controls">
{include file="views/theme_editor/components/colorpicker.tpl" cp_name="static_data[abt__ut2_mwi__label_color]" cp_id="abt__ut2_mwi__label_color_{$id}" cp_value=$static_data.abt__ut2_mwi__label_color|replace:"transparent":""|default:"#ffffff"}
</div>
</div>
{** label background **}
<div class="control-group">
...
<div class="controls">
{include file="views/theme_editor/components/colorpicker.tpl" cp_name="static_data[abt__ut2_mwi__label_background]" cp_id="abt__ut2_mwi__label_background_{$id}" cp_value=$static_data.abt__ut2_mwi__label_background|replace:"transparent":""|default:"#ffffff"}
</div>
</div>
</fieldset>
