...
$image_row = db_get_row('SELECT * FROM ?:images WHERE image_id = ?i', $temporal[$img_type]['image_id']);
$temporal['images'][$new_type]['data']['is_high_res'] = isset($image_row['is_high_res']) && $image_row['is_high_res'] === 'Y';
}
...
$uk = fn_get_banner_data($id, 'uk');
$temporal['uk'] = [
'banner' => $uk['banner'],
'abt__ut2_button_text' => $uk['abt__ut2_button_text'],
'abt__ut2_title' => $uk['abt__ut2_title'],
'abt__ut2_description' => $uk['abt__ut2_description'],
];
